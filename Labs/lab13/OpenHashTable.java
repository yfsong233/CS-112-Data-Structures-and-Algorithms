...
public class OpenHashTable implements HashTable {
    ...
    public static void main(String[] args) {
        ...
        // create an hash table of size 7 using double hashing
        ...
        /* 2-3 */
        System.out.println( table.insert("bee", 50) );  // true
        // If we make the call to insert(), within a System.out.println statement, 
        // we will see that this method returns either true 
        // (if the key-value pair was successfully inserted) 
        // or false (if there was overflow and the key-value pair could not be inserted).

        /* 2-4 */
        System.out.println( table.search("ant") );  // {23, 30}
        // search for a given key and return an LLQueue object containing the values associated with the key if found
        System.out.println( table.search("antelope") );  // null
        // return null if not found

        /* 2-5 && 2-6 */
        table.insert("cow", 10);
        Queue<Object> values = table.search("cow");  // {10}
        System.out.println(values);

        /* 2-7 & 2-8 */
        int val = (Integer)values.remove();  // remove an item in an LLQueue
        table.insert("cow", val*2);
        // change the value associated with the key "cow" 
        // – multiplying its current value (which you should pretend that you don’t know) by 2
        System.out.println(table.search("cow"));  // {20}
